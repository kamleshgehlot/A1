...
const budget = "CREATE TABLE IF NOT EXISTS budget(`id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, `work` double(10,2) DEFAULT NULL, `benefits` double(10,2) DEFAULT NULL, `accomodation` double(10,2) DEFAULT NULL, `childcare` double(10,2) DEFAULT NULL, `other_income` double(10,2) DEFAULT NULL, `rent` double(10,2) DEFAULT NULL, `power` double(10,2) DEFAULT NULL, `landline_phone` double(10,2) DEFAULT NULL, `mobile_phone` double(10,2) DEFAULT NULL, `vehicle_finance` double(10,2) DEFAULT NULL, `public_transport` double(10,2) DEFAULT NULL, `food` double(10,2) DEFAULT NULL, `credit_store_cards` double(10,2) DEFAULT NULL, `loans_hire_purchase` double(10,2) DEFAULT NULL, `other_expenditure` double(10,2) DEFAULT NULL, `total_income` double(10,2) DEFAULT NULL, `total_expenditure`  double(10,2) DEFAULT NULL, `total_surplus` double(10,2) DEFAULT NULL, `afford_amt` double(10,2) DEFAULT NULL, `is_active` tinyint(4) DEFAULT NULL, `created_by` int(11) DEFAULT NULL, `updated_by` int(11) DEFAULT NULL, `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id))";
const flex_order = "CREATE TABLE IF NOT EXISTS flex_order(`id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, `goods_rent_price` double(10,2) NOT NULL, `ppsr_fee` double(10,2) NOT NULL, `liability_fee` double(10,2) NOT NULL, `weekly_total` double(10,2) NOT NULL, `frequency` double(10,2) NOT NULL, `first_payment` double(10,2) NOT NULL, `no_of_payment` double(10,2) NOT NULL, `each_payment_amt` double(10,2) NOT NULL, `total_payment_amt` double(10,2) NOT NULL, `before_delivery_amt` double(10,2) NOT NULL, `exp_delivery_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `bond_amt` double(10,2) NOT NULL, `is_active` tinyint(4) DEFAULT NULL, `created_by` int(11) DEFAULT NULL, `updated_by` int(11) DEFAULT NULL, `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id))";
const fixed_order = "CREATE TABLE IF NOT EXISTS fixed_order(`id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, `int_unpaid_bal` double(10,2) NOT NULL, `cash_price` double(10,2) NOT NULL, `delivery_fee` double(10,2) NOT NULL, `ppsr_fee` double(10,2) NOT NULL, `frequency` double(10,2) NOT NULL, `first_payment` double(10,2) NOT NULL, `last_payment` double(10,2) NOT NULL, `no_of_payment` double(10,2) NOT NULL, `each_payment_amt` double(10,2) NOT NULL, `total_payment_amt` double(10,2) NOT NULL, `before_delivery_amt` double(10,2) NOT NULL, `exp_delivery_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `minimum_payment_amt` double(10,2) NOT NULL, `intrest_rate` double(10,2) NOT NULL, `intrest_rate_per` double(10,2) NOT NULL, `total_intrest` double(10,2) NOT NULL, `is_active` tinyint(4) DEFAULT NULL, `created_by` int(11) DEFAULT NULL, `updated_by` int(11) DEFAULT NULL, `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id))";
