...
export default function Active({productList, roleName, handleClickEditOpen, page, rowsPerPage, handleChangePage, handleChangeRowsPerPage}) {
...
return (  
  <Table stickyHeader>
    ...
    <TableBody>
      { (productList.length > 0 ? productList : []).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((data, index)=>{
        return(
