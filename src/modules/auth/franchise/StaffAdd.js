...
//     // Need to change below implementation of generating staff user Id.
//     setInput('user_id', inputs.name.substring(0, 4).toLowerCase() + '_' + inputs.name.substring(0, 4).toLowerCase()) + id;
//   }
